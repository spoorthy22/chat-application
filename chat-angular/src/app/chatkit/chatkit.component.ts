...
@Component({
  ...
  templateUrl: './chatkit.component.html',
  styleUrls: ['./chatkit.component.css']
})

export class ChatkitComponent  {
  userId = '';
  currentUser = <any>{};
  messages = [];
  currentRoom = <any>{};
    ...
    axios.post('http://localhost:5200/users', { userId })
      .then(() => {
        ...
        const chatManager = new Chatkit.ChatManager({
          instanceLocator: 'v1:us1:c235cae0-8df7-4d47-8876-c3ffb7be09a3',
          userId,
          tokenProvider
        });
